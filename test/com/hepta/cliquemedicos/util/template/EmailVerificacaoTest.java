...
/**
 * 
 * Testes unitários do template de verificação de email
 *
 */
public class EmailVerificacaoTest {
	...
	@Test
	public void givenCamposDTO_whenEmailVerificacao_thenReturnEmailVerificacaoTemplate() {
		...
		// when
		String template = 
				EmailVerificacao.getTemplate(camposEmailDTO, "451656b2-cd0a-4fd6-b812-a4749834ca02");
