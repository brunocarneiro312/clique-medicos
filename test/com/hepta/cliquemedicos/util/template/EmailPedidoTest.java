...
public class EmailPedidoTest {
	...
	public void givenCamposDTO_whenEmailCancelado_thenReturnEmailCanceladoTemplate() {
		...
		// when
		String template = EmailPedido.getTemplate(camposEmailDTO);
