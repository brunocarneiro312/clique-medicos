...
public class EmailAssociadoCanceladoTest {
	...
	@Test
	public void givenCamposDTO_whenEmailAssociadoCancelado_thenReturnEmailAssociadoCanceladoTemplate() {
		...
		// when
		String template = EmailAssociadoCancelado.getTemplate(camposEmailDTO);
