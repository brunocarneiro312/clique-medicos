...
public class EmailCanceladoTest {
	...
	public void givenCamposDTO_whenEmailCancelado_thenReturnEmailCanceladoTemplate() {
		...
		// when
		String template = EmailCancelado.getTemplate(camposEmailDTO);
